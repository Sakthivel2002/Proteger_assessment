...
const DepartmentHeader = ({ title, department, stats }) => {
  return (
    <div className="bg-[#253E86] rounded-xl px-6 py-4 text-white flex justify-between items-start">
      <div>
...
const SimpleDepartmentHeader = ({ department }) => {
  return (
    <div className="bg-[#253E86] rounded-xl px-6 py-4 text-white font-medium">
      Department : {department}
    </div>
  );
};

export default function WorkOrderPerDept() {
  return (
