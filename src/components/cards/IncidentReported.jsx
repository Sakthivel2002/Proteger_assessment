...
export default function IncidentReported() {
  return (
            ...
            return (
              <div key={idx} className="flex items-center">
                ...
                <div className="flex-1 h-6 flex rounded-md overflow-hidden">
                  {/* Open */}
                  <div
                    className="bg-[#56ABF8] flex items-center justify-end pr-2 text-white text-xs"
                  ...
                  {/* Closed */}
                  <div
                    className="bg-[#D2EAFF] flex items-center justify-end pr-2 text-[#243E8F] text-xs"
